	...
	return (
		...
		<form method="get" action="/issues" className="issue-form issue-filters">
			<fieldset>
				...
				{/*
				  項目を並べる箱（Issue #95）。以前は 5 項目が縦に積まれ、
				  絞り込みだけで画面が埋まって一覧が下に押しやられていた。
				  何列にするかは CSS が幅から決める（日本語と英語で
				  ラベルの長さが変わるため、列数を数値で決め打ちしない）
				*/}
				<div className="issue-filters-fields">
				...
				<p className="issue-filters-actions">
